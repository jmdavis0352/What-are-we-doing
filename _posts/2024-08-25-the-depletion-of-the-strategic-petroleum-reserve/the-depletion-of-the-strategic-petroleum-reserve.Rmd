...
```{r pairs, preview = TRUE,fig.height = 5.5, fig.width=10, fig.cap= "Possible data comparisons Rep Cole could have used to make the claim that 'America is producing nearly two million barrels a day less than we were in 2020'"  }

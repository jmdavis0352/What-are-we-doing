...
ggplot(subset(Production, Month >= my('10-2019') & Month <= my('03-2022') ), aes(x = Month, y = Barrels)) + geom_line(colour = '#00468B', size = 1.2) + 
  ...
  annotate('text', x = my('07-2021'), y = 12.8e6, hjust = .4, label = 'Origin date for comparison', size = 5 )  +
  annotate('point', x = my('03-2021'), y = 12.8e6, colour = 'red', size = 6, alpha = .6 )
...
**It is implausible that this comparison is a mistake. Rep Cole (or someone in his office who prepared the statement) intended to portray U.S. oil production suffering directly from an imagined Biden Administration action and found data that would allow them to construct something that wasn't *entirely* false, but did not convey truth.** 

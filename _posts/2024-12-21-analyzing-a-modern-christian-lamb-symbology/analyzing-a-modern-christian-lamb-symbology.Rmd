...
we are frequently not thinking critically. @munusamy_psychological_2024
...
[^4]: I don't think any of the gods of Egypt (or of any culture)
    ...
    [@hallo_approaches_2020] and many many other). Most scholars
    ...
    discussion of P's redeaction of the Plague narratives see
    [@zevit_priestly_1976]
...
then how are we to understand the analogy to a lamb and how are we to understand these sacrifices? Why is Jesus so frequently referred to as "The Lamb"? Why does Jesus need to sacrifice his human life^[It's a bit strange to say he died or sacrificed his life when he is thought to be an immortal entity that is consubstantial with and fully equal to God who is also **`r yahweh`** (Yahweh), the very God of Israel] to somehow, in some way, offset or pay for or atone for the sins of the world. How does that work? What is the mechanism by which Jesus suffering a terrible death enables salvation? Salvation from what? How do modern Christians understand the status quo if Jesus had not yet spent a while as a human so that humans could murder him? For instance, what was the status quo with respect to salvation in the year 10 CE? 
...
translators. Modern translations usually state "cypress" (NRSVU for
...
An example from Charlie Kirk is similar (many versions of this quote are evident on the YouTube -- search at your leisure)
...
lutzdat %>% group_by(Bible, Position) %>% summarise(Citations = sum(Citations)) %>% ggplot() + geom_col(aes(x = Bible, y = Citations, fill = Position), position = position_dodge()) + scale_fill_aaas() + geom_label(aes(x = Bible, y = Citations, foo = Position, label = Citations), position = position_dodge(width = .9), hjust = .5) + labs(x = NULL, y = 'Number of Citations Among Published\nPolitical Writings in 1787 and 1788') + theme_minimal() + theme(legend.title = element_blank())
...
It may be that modern commentators like Prager and Kirk and Beck are only experiencing Lutz's work through Barton's lens.
...
On page 130 of my copy of Barton's book, in a section titled "What did the Father's Say to Teach?", he argues that the Founding Father's wanted education to be overtly Christian and focused on the Bible, and he [@barton_myth_1992] states "Notice why Jefferson felt the Bible as being essential in any successful plan of education" and he quotes Jefferson as as saying:

>I have always said, and will always say, that the studious perusal of the sacred volume will make us better citizens"

Did Jefferson really think the Bible an essential component of education? He doesn't actually say so in this quote, but let us investigate. 

The statement above isn't actually primary quote from Jefferson. The statement is attributed to Jefferson in a letter written by Daniel Webster in 1852 which describes a conversation he is reporting to have had with Jefferson *27 years earlier* (see a short discussion at [Monticello](https://www.monticello.org/research-education/thomas-jefferson-encyclopedia/bible-source-liberty-spurious-quotation/)). I think it's plausible Jefferson said something like this. But is that all that Jefferson had to say about teaching the Bible, or education in general or Christianity in general?
...
Thomas Jefferson, in a letter to Alexander Smyth, 1825 [@jefferson_thomas_1825]
...
Thomas Jefferson in a letter to Peter Carr, 1787 [@jefferson_thomas_1787]
...
Benjamin Franklin in a letter to Ezra  Stiles  (January  28,  1790) [@franklin_writings_1905]
...
Thomas Paine in the *Age of Reason* [@paine_writings_1796]
...
Further such writings and accounts exist but I shall not here make it my mission to reproduce them all (for a summary discussion see [@allen_our_2005]).
...
tribulation when all the prophecies would come true preceeding Jesus'
...
catastrophically corrupts their ability to make policy and law that
"promote[s] the general welfare" (U.S Constitution, Preamble.) and
...
> (NRSVU) 19 Then there was another battle with the Philistines at Gob,
...
Fully examining this topic would require a book, but a two
...
this document, I'm not going provide an analysis of each one, but will
...
-   Colossians
-   Ephesians
-   Luke/Acts (some technical gray area on calling it a "forgery" -- the
...
getting arthritic in my fingers and I'm tired of looking up the names.
...
[^41]: I dind't know this about Jefferson until a few years ago.
    ...
    rejected the supernatural in general. In the Presidential Election
    ...
    search engine. Thomas Paine was also a Deist and loudly rejected the
    doctrines and creeds and dogmas of organized religion in the
    introduction to is 1796 publication "The Age of Reason". He states
    plainly: "I believe in one God, and no more; and I hope for
    ...
    power and profit" [@paine_writings_1796]. I tend to agree.
...
> (NRSVU -- hebrew for Yahweh added) 4 **`r yahweh`**, when you went out
...
> (NRSVU -- hebrew for Yahweh added) 1 Bless **`r yahweh`**, O my soul.
...
> (NRSVU) 7 Remember the days of old; consider the years long past; ask your father, and he will inform
...
that is reflected in NRSVU and other modern translations.
...
original text of the poem in Deut. XXXii.5 In this understanding, the
...
All of the above is very different from the conception of God we have by
the 2nd century BCE and after -- when God is no longer named with a
proper name, is less anthropomorphic, and by the time of the early
Christian writers -- the conception of God is quite markedly steeped in
Greek philosophical frameworks -- almost certainly because Jews were
exposed to Greco-Roman culture and ideas as the Roman Empire encroached
upon and finally conquered ancient Palestine in 63 BCE, and because
early Christian thinkers were educated in Greek schools (all of the New
Testament writings were originally written in Greek).

But changes in Christian conceptualizations of God didn't stop in the
1st Century CE.

##### **The Trinity**

The Doctrine of the Trinity is a post-Biblical innovation that wasn't
mature in Christian theology until the 5th century CE or so (strictly
...
suggestion that it's not in the Bible by thinking of 1 John 5:7
...
> (NRSVU) **5** Who is it who conquers the world but the one who
...
-   of the \~500 Greek manuscripts in existence that contain 1 John 5,
    the *Comma Johanneum* is only found in at most *ten*[^44]
...
[^44]: Counts vary between 8 and 10 -- some of these are marginal notes
    ...
    form of the text (with chapter and verse indicate it was added based
...
Latin in the Western Empire in the mid 2nd to early 3rd century CE who
...
> period of ten centuries. After the invention of printing, 119 the
> editors of the Greek Testament yielded to their own prejudices, or
> those of the times; 120 and the pious fraud, which was embraced with
...
texts as best we can reconstruct them describe a Triune God. No such
...
God of Israel, and this presented a problem for the Monotheistic Jews
...
-   A long detailed history of thought progression is available at the
...
up to First Nicaea in 325 -- at this point there were two major factions
...
required about 1,000 pages of reading. While this
...
entire book, but I want to examine just one example I encountered while
...
[^48]: Many state this assumption plainly in their arguments. For
    ...
    occurred and that it occurred in 1446 BCE (the Biblical timeline).
    He reaches these conclusions "based on my view of the nature of
...
way possible to make the data fit the dogma (of Inspiration, of
Inerrancy etc.).
